...
from tf_buildkernel import fuzzy_spherical_kernel, fuzzy_kpconv_kernel
...
def separable_conv3d(inputs,
    ...
    Args:
        ...
        filt_coeff: int32 array, filter bin indices (nonzero coefficient)
    ...
    with tf.variable_scope(scope,reuse=reuse) as sc:
        ...
        outputs = tf_conv3d.fuzzy_depthwise_conv3d(inputs, depthwise_kernel, nn_index,
